    ...
    <div className="min-h-screen bg-gray-100 px-4 py-8 font-sans">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-8 rounded-xl border border-gray-200 bg-white p-6 shadow-md md:p-8">
          ...
          <div className="inline-flex rounded-lg border-gray-200 bg-gray-100 p-1 shadow-sm">
            <Button
              className={`rounded-md px-6 py-2 font-medium text-base transition-colors duration-200 ${
                activeTab === "overview"
