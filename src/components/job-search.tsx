...
export const JobSearch = () => {
  ...
  return (
    <div className="flex items-center justify-center py-4">
      <div className="w-full max-w-5xl rounded-2xl border border-gray-200 bg-white p-2 py-4 shadow-sm transition-all ease-in-out hover:border-blue-500">
        <div className="rounded-2xl bg-[#F8FAFC] p-6 md:p-8">
          {/* Main Search Bar */}
          <div className="mb-6 flex items-center space-x-2 rounded-full border border-gray-200 bg-white p-1 shadow-sm transition-all ease-in-out focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500">
            <Input
